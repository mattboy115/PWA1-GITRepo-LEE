...
console.log('------Object within an object, Arrays, Function ----------');
	...
	var thatGuy = {
		...
		showMyAddress : function() {
			var addr = this.address.num + ',' + this.address.street + ',' + this.address.city;
			return addr;
		}
	};
...
// this is integrating multiple data types - object with an array of objects
	...
	var mySchool = {
		...
		students: [
			...
			{name: 'Cindy Vortex', GPA: 4.0, classes: ['Theoretical Physics 2', 'Quantum Mechanics']},
			{name: 'Jimmy Neutron', GPA: 5.0, classes: ['SCIENCE!!!']}
		]
	}

	console.log(mySchool.schoolName, mySchool['schoolName']);

	var newCnt = mySchool.studentCount;

	console.log(mySchool['address'])

	console.log('James Bond\'s GPA is ' + mySchool.students[0].GPA);
...
----------------------------------------------------------------------------- */
	...
	console.log('Average Grade: ', gradeAvg(mySchool));
...
*/
    ...
    var students = {name: "JamesBond", gender: "male", job: "sutdent"};
...
console.log('------------ getElementById -------------------');
	...
	playbox.style.backgroundColor = 'orange';
...
/*
	...
	------------------------------------------------------------------
        ...
        attr = href, src, class
*/
console.log('------------ Manipulating HTML Attributes -------------------');
